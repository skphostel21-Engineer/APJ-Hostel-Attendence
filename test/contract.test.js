...
test('18. Firestore database is configured in index.html and firebase.json', () => {
  assert.match(firebaseJsonSource, /"database":\s*"(?:\(default\)|apj-hostel-db)"/);
  assert.match(htmlSource, /firebase\.app\(\)\.firestore/);
});
